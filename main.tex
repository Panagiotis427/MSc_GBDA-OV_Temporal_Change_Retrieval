...
\begin{figure}[H]
    ...
    (\subref{fig:mapbars_train}) collapse on the held-out test split
    (\subref{fig:mapbars_test}), where frozen zero-shot is competitive --- the
    memorisation signature quantified in Sections~\ref{sec:crosssplit}
    and~\ref{sec:audit}.}
    \label{fig:mapbars}
\end{figure}
