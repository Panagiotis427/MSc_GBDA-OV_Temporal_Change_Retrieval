...
| `scripts/patch_eval.py` | patch-level (localised) Δ-similarity change retrieval vs the global baseline (REPORT Appendix B.10, "S3"); caches per-patch embeddings via `encoder.encode_image_patches` |
