...
encoders, synthetic fixture, no network) passes 240 tests; the full suite is 256
(255 passed, 1 skipped: the real-CLIP text-encoder test needs weights) and covers
...
\begin{table}[H]
    ...
    \begin{tabular}{lr}
        ...
        Fast test suite - 240 tests, mock encoders, CPU & $\approx$65\,s \\
        \bottomrule
    \end{tabular}
\end{table}
...
(Sections~\ref{sec:denmain},~\ref{sec:nativeraster}): the ceiling is the frozen
...
study with GeoRSCLIP (ViT-B/32) gives macro $0.146$ vs the same $0.208$ floor --- at
