...
for the first time --- four of the nine change-types are FDR-significant in this configuration --- with new water borderline ($q{=}0.053$)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{zeroshot_vs_peft__clip_vitl14__train_part1.png}\\[4pt]
