...
\texttt{train\_v2.py} and \texttt{evaluate\_v2.py}), which is \emph{not} part of the
...
As a second, independent check --- this time \emph{zero-shot} and under the
...
$0.130\pm0.068$) sits \emph{at or above} the JPEG subset ($0.076$; $0.123$ under
